...
- **Programming & Scripting**: Python (Cybersecurity Automation), Bash, PowerShell, SQL Injection Testing   
- **Certifications & Training**: Google Cybersecurity Certificate, CompTIA Security+ (Target)  
